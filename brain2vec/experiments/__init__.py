...
#        result_options_df, opt_cols = upack_result_options_to_columns(results_df,
#                                                                      parse_cv_and_epoch_results=False)
#
...
#
#        pretrain_parser = cls.preprocess_pretraining_results(result_options_df,
#                                                             pretrained_results_col=pretrain_col,
#                                                             indicator_eval_d=indicator_eval_d
#                                                             )
#
#        return cls.ParsedResults(result_options_df,
#                                 pretrain_parser,
#                                 opt_cols,
#                                 None, None, None,
...
#                                 )
    ...
    def preprocess_pretraining_results(cls, result_options_df: pd.DataFrame,
        ...
        # opt_cols) = upack_result_options_to_columns(
        #    pretrained_results_df,
